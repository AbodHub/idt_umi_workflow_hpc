...
DATA_DIR = pathlib.Path("/home/abod/scratch/rrdlbcl_pc1/rrDLBCL_CAPP_seq").expanduser()
...
samplesdf = pd.DataFrame().assign(Sample=samples ,
                               R1_file=[x.name for x in fqread1], 
                               R2_file=[x.name for x in fqread2])
